    ...
    def mostrar_tabla(self, nombre_tabla):
        ...
        if nombre_tabla == "personas":
            ...
            try:
                ...
                vista_docentes = DocentesView(self.page, self.cambiar_vista)
                self.cambiar_vista(vista_docentes)
                return
            except Exception as e:
                print(f"Error al cargar vista de docentes: {str(e)}")
                # Mostrar diálogo de error
                dlg = ft.AlertDialog(
                    title=ft.Text("Error"),
                    content=ft.Text(f"No se pudo cargar la vista de docentes: {str(e)}"),
                    actions=[
